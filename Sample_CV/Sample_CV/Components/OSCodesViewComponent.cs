      ...
      public IViewComponentResult Invoke()
        {
            ...
            {
                new OSCode(1,"OScode1.png","یک سامانه ساده مدیریت مشتریان و حسابداری با تکنولوژی asp.net mvc","یک پروژه ی 4 لایه تحت وب که با استفاده از entity framework codefirst  جهت سامانه مشاوره انلاین های اکسپرت پیاده سازی شد کلیه عملیات crud انجام می شود و با هر بار پرداخت مشتری به درامد مشاور اضافه می شود و با هر بار تسویه حساب مشاور از دارمدش کم یم شود ","https://github.com/MarziehFatemi/Sample_MVC_Project"),
                new OSCode(2,"OScode2.png","یک پروژه CRM ساده در ویندوز با استفاده از Entity framework"," یک پروژه سه لایه حسابداری و مدیریت مشتریان برای سایت های اکسپرت در محیط ویندوز و با استفاده از sql server  و entityframework code first کلیه عملیات crud و سرچ و فیلتر انجام می شود با هر خرید کاربر به درامد مشاورین اضافه می شود." ,"https://github.com/MarziehFatemi/EntityFramework_sampleproject_3Layer"),
                new OSCode(3,"OScode3.png", "پروژه CRM با استفاده از sql server و ADO.net",
